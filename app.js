...
const titleCasing = require(__dirname + "/titleCase.js");
...
app.post("/compose", function (req, res) {
  ...
  // const postTitle = titleCasing.titleCase(req.body.postTitle);
...
app.get("/posts/:postName", function(req, res) {
  // const postName = titleCasing.titleCase2(req.params.postName);
  ...
  posts.forEach(function(post) {
    ...
    if (requestedTitle === storedTitle) {
      ...
      console.log("No matches! Error 404!");
    }
  });
